 ...
 */
final class Version20230309094054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Attempts (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, test_id INT NOT NULL, date_attempt DATETIME NOT NULL, score DOUBLE PRECISION NOT NULL, INDEX IDX_46B18532A76ED395 (user_id), INDEX IDX_46B185321E5D0459 (test_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
